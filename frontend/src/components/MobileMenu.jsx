...
export default function MobileMenu({ isOpen, onClose }) {
  ...
  useEffect(() => {
    if (isOpen) {
      fetchUnreadCount()
      // MobileMenu açıldığında event dispatch et (ChatPage'deki sidebar'ı kapatmak için)
  ...
  return (
    <>
      ...
      {/* Sliding Menu */}
      <div className="fixed inset-y-0 left-0 w-full sm:w-80 bg-black border-r border-gray-800 z-50 lg:hidden overflow-y-auto transform transition-transform duration-300 ease-in-out">
        {/* Header */}
        ...
        <div className="p-4">
          ...
          <button
            ...
            className="w-full mb-4 flex items-center justify-between px-4 py-3 bg-gray-900 hover:bg-gray-800 rounded-lg border border-gray-800 transition-all"
          >
            <div className="flex items-center space-x-3">
          ...
          <button
            ...
            className="w-full mt-6 flex items-center justify-center space-x-2 px-4 py-3 bg-red-600 hover:bg-red-700 text-white rounded-lg transition-all font-medium"
          >
